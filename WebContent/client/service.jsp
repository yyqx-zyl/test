...
<body>
 ...
 <div class="content width1037">
   <h3 class="titles2">
    <img src="images/serviceTitle.jpg" width="181" height="42" />
...
wedding documentary, American fresh"
   ...
   <div class="service">
    <dl>
     <dt><a href="info.html"><img src="images/ser1.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">设计师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
     </dd>
    </dl>
    <dl>
     <dt><a href="info.html"><img src="images/ser2.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">化妆师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
    ...
    <dl>
     <dt><a href="info.html"><img src="images/ser3.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">设计师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
    ...
    <dl>
     <dt><a href="info.html"><img src="images/ser4.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">化妆师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
...
2005年毕业伦敦艺术大学<br />
   ...
   <div class="serimg">
    <h3><img src="images/servicetitle2.png" width="939" height="176" /></h3>
    <img src="images/tuandui.jpg" width="949" height="274" /><br />
    <img src="images/tuandui.jpg" width="949" height="274" />
   </div><!--serimg/-->
 </div><!--content/-->
 <div class="ftContact">
  <div class="width950">
...
<body>
 ...
 <div class="content width1037">
   <h3 class="titles2">
    <img src="${ctx}/static/images/serviceTitle.jpg" width="181" height="42" />
    <strong>2015新式纪实风，首创美学新纪元！“色彩主题、婚礼纪实、美式清新”</strong>
    <span>
     2015 new documentary style, the first aesthetic era! "Color themes, <br />
wedding documentary, American fresh"
   ...
   <div class="service">
    <dl>
     <dt><a href="${ctx}/client/info.jsp"><img src="${ctx}/static/images/ser1.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">设计师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
    ...
    <dl>
     <dt><a href="${ctx}/client/info.jsp"><img src="${ctx}/static/images/ser2.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">化妆师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
    ...
    <dl>
     <dt><a href="${ctx}/client/info.jsp"><img src="${ctx}/static/images/ser3.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">设计师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
2005年毕业伦敦艺术大学<br />
    ...
    <dl>
     <dt><a href="${ctx}/client/info.jsp"><img src="${ctx}/static/images/ser4.png" width="145" height="145" /></a></dt>
     <dd class="serTitle">化妆师</dd>
     <dd class="serTitle2">WEIJIAYIN</dd>
     <dd class="serTitleText">
      2003年英国留学<br />
...
2005年毕业伦敦艺术大学<br />
   ...
   <div class="serimg">
    <h3><img src="${ctx}/static/images/servicetitle2.png" width="939" height="176" /></h3>
    <img src="${ctx}/static/images/tuandui.jpg" width="949" height="274" /><br />
    <img src="${ctx}/static/images/tuandui.jpg" width="949" height="274" />
   </div><!--serimg/-->
 </div><!--content/-->
 <div class="ftContact">
  <div class="width950">
