...
<body>
 ...
 <div class="content width1037">
   <h3 class="titles2">
    <img src="images/cheliang-title.png" width="178" height="42" />
...
wedding documentary, American fresh"
   ...
   <div class="decoration">
    <dl>
     <a href="info.html" class="decMore"><img src="images/mores.png" width="55" height="56" /></a>
     <dt><img src="images/c1.jpg" width="457" height="302" /></dt>
     <dd>
      <h3><a href="info.html">凯迪拉克XX系列跑车</a></h3>
      <div class="decorPar">
       <a href="info.html">保时捷（Panamera）+凯迪拉克（CTS）+劳斯莱斯+（银云 白色版）+劳斯莱斯（古思特）任选一项</a>
      </div><!--decorPar/-->
     </dd>
    </dl>
    <dl>
     <a href="info.html" class="decMore"><img src="images/mores.png" width="55" height="56" /></a>
     <dt><img src="images/c2.jpg" width="457" height="302" /></dt>
     <dd>
      <h3><a href="info.html">凯迪拉克XX系列跑车</a></h3>
      <div class="decorPar">
       <a href="info.html">保时捷（Panamera）+凯迪拉克（CTS）+劳斯莱斯+（银云 白色版）+劳斯莱斯（古思特）任选一项</a>
    ...
    <dl>
     <a href="info.html" class="decMore"><img src="images/mores.png" width="55" height="56" /></a>
     <dt><img src="images/c3.jpg" width="457" height="302" /></dt>
     <dd>
      <h3><a href="info.html">凯迪拉克XX系列跑车</a></h3>
      <div class="decorPar">
       <a href="info.html">保时捷（Panamera）+凯迪拉克（CTS）+劳斯莱斯+（银云 白色版）+劳斯莱斯（古思特）任选一项</a>
    ...
    <dl>
     <a href="info.html" class="decMore"><img src="images/mores.png" width="55" height="56" /></a>
     <dt><img src="images/c4.jpg" width="457" height="302" /></dt>
     <dd>
      <h3><a href="info.html">凯迪拉克XX系列跑车</a></h3>
      <div class="decorPar">
       <a href="info.html">保时捷（Panamera）+凯迪拉克（CTS）+劳斯莱斯+（银云 白色版）+劳斯莱斯（古思特）任选一项</a>
   ...
   <h3 class="titles2">
    <img src="images/che-titles.png" width="178" height="42" />
    <strong>2015新式纪实风，首创美学新纪元！“色彩主题、婚礼纪实、美式清新”</strong>
    <span>
     2015 new documentary style, the first aesthetic era! "Color themes, <br />
wedding documentary, American fresh"
   ...
   <div class="decorationNew">
    <div class="decList">
     <a href="info.html"><img src="images/c1.jpg" width="230" height="150" /></a>
     <a href="info.html"><img src="images/c2.jpg" width="230" height="150" /></a>
     <a href="info.html"><img src="images/c3.jpg" width="230" height="150" /></a>
     <a href="info.html"><img src="images/c4.jpg" width="230" height="150" /></a>
    </div><!--decLis150/t-->
    <div class="decList">
     <a href="info.html"><img src="images/c1.jpg" width="230" height="150" /></a>
     <a href="info.html"><img src="images/c2.jpg" width="230" height="150" /></a>
