...
<body>
 ...
 <div class="banner" style="background:url(images/ban3.jpg) center top no-repeat;">
  <div class="gonggao">
...
访客观网指南：尊敬的访客您好！欢迎来到天之元官方网站。 您在这里会看到来自天之元婚纱摄影的各种风格样片。
 ...
 <div class="content width1037">
   <h3 class="titles2">
    <img src="images/changjign-title.png" width="179" height="41" />
   ...
   <div class="scene">
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="info.html" class="sceneMore">&nbsp;</a>
       <img src="images/s3.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="info.html" class="sceneMore">&nbsp;</a>
       <img src="images/s4.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="info.html" class="sceneMore">&nbsp;</a>
       <img src="images/s1.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="info.html" class="sceneMore">&nbsp;</a>
       <img src="images/s2.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
...
<body>
 ...
 <div class="banner" style="background:url(${ctx}/static/images/ban3.jpg) center top no-repeat;">
  <div class="gonggao">
   <div class="marquees width950">
    <marquee direction="left" onmouseover=this.stop() onmouseout=this.start()>
访客观网指南：尊敬的访客您好！欢迎来到天之元官方网站。 您在这里会看到来自天之元婚纱摄影的各种风格样片。
 ...
 <div class="content width1037">
   <h3 class="titles2">
    <img src="${ctx}/static/images/changjign-title.png" width="179" height="41" />
    <strong>2015新式纪实风，首创美学新纪元！“色彩主题、婚礼纪实、美式清新”</strong>
    <span>
     2015 new documentary style, the first aesthetic era! "Color themes, <br />
wedding documentary, American fresh"
   ...
   <div class="scene">
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="${ctx}/client/info.html" class="sceneMore">&nbsp;</a>
       <img src="${ctx}/static/images/s3.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="${ctx}/client/info.jsp" class="sceneMore">&nbsp;</a>
       <img src="${ctx}/static/images/s4.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="${ctx}/client/info.jsp" class="sceneMore">&nbsp;</a>
       <img src="${ctx}/static/images/s1.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
     ...
     <dd>
      <div class="sceDD">
       <div class="sceBg">&nbsp;</div>
       <a href="${ctx}/client/info.jsp" class="sceneMore">&nbsp;</a>
       <img src="${ctx}/static/images/s2.jpg" width="285" height="387" />
      </div><!--sceDD/-->
     </dd>
    </dl>
    <dl>
