            ...
            <div class="layui-card">
            	<div class="table-responsive">
			 		   <table class="layui-table" lay-skin="line" lay-size="lg" id="table">						  
						  ...
						  <tbody>
						      <tr>
							      <td><input type="text" readonly="readonly" class="layui-input" value="编号"></td>
							      <td>						      	  
							      	  <div id="layer-photos-demo" class="layer-photos-demo">
									      <img layer-pid="" layer-src="" src="" alt="图片名">
									  </div>
							      </td>
							      <td class="layui-form">
							         <input type="text" readonly="readonly" class="layui-input" value="商品名称">
							      </td>	
							      <td class="layui-form">
							         <input type="text" readonly="readonly" class="layui-input" value="商品描述">
							      </td>
							      <td class="layui-form">
							         <input type="text" readonly="readonly" class="layui-input" value="商品价格">
							      </td>					     
							      <td>
						  ...
						  <%-- 	<c:forEach items="${pageInfo.list }" var="dress">
						  		<tr>
							      <td><input type="text" readonly="readonly" class="layui-input" value="${dress.pid }"></td>
							      <td>						      	  
							      	  <div id="layer-photos-demo" class="layer-photos-demo">
									      <img layer-pid="" layer-src="/uploadFile/${dress.picpath }" src="/uploadFile/${dress.picpath }" alt="图片名">
									  </div>
							      </td>
							      <td class="layui-form">
